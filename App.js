      ...
      <div>
        ...
        <div>
          <div class='container'>
            ...
            <button class='grid-item item3' onClick={this.add1000PointJonno}>
              +5
            </button>
          ...
          <div class='container'>
            ...
            <button class='grid-item item3' onClick={this.add1000Pointfish}>
              +5
            </button>
          ...
          <div class='container'>
            ...
            <button class='grid-item item3' onClick={this.add1000Pointmatt}>
              +5
            </button>
          ...
          <div class='container'>
            ...
            <button class='grid-item item3' onClick={this.add1000Pointtuhin}>
              +5
            </button>
          ...
          <div class='container'>
            ...
            <button class='grid-item item3' onClick={this.add1000Pointben}>
              +5
            </button>
